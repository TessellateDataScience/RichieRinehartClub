...
2. Download our [base notebook]() then navigate into a directory where Docker will see it. On Windows: `cd \Users\username\richie`
...
4. Enable the environment: `docker run -it -v "$(pwd):/home/jovyan/work" -p 8888:8888 nchowlett/data-science:0.1`
